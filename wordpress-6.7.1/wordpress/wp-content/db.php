...
$sqlite_plugin_implementation_folder_path = 'C:\Git\wordpress-runner\wordpress-6.7.1\wordpress\wp-content\plugins\sqlite-database-integration';
...
add_action(
	...
	function() {
		...
		if ( is_plugin_inactive( 'C:\Git\wordpress-runner\wordpress-6.7.1\wordpress\wp-content\plugins\sqlite-database-integration\load.php' ) ) {
			...
			if ( null !== activate_plugin( 'C:\Git\wordpress-runner\wordpress-6.7.1\wordpress\wp-content\plugins\sqlite-database-integration\load.php', '', false, true ) ) {
